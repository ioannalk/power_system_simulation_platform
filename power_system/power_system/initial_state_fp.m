function [V_n, I_br, max_f1, max_f2] = initial_state_fp(time, rlc, src, No_Brn, No_Nodes, No_Src, max_f1, max_f2)
    ...
    if No_Vk ~= 0
        ...
        [V_U, max_f1, max_f2] = Vnodal_fp(I0, I0_U, G0, G0_UU, G0_UK, Vk, 1, max_f1, max_f2);
        c = 0;
        for i=1:No_Nodes
        ...
        [V_n, max_f1, max_f2] = Vnodal_fp(I0, [], G0, [], [], 0, 0, max_f1, max_f2);
    end
