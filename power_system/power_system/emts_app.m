...
while count <= size(time,2)
    ...
    [I_hs, unused_f1, unused_f2] = Ihs_assign(No_Brn, rlc, I_hs, V_n, I_br, unused_f1, unused_f2);
    [I_history, unused_f1, unused_f2] = I_history_assign(No_Nodes, No_Brn, No_Src, rlc, src, I_hs, unused_f1, unused_f2);
    ...
    [I_br, unused_f1, unused_f2] = Ibr_assign(No_Brn, rlc, I_hs, V_n, G_br, I_br, unused_f1, unused_f2);
